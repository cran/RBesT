...
success <- oc2Sdecision(pc=c(0.90, 0.50), qc=c(log(1), log(0.50)), lower.tail=TRUE, link="log")
futility <- oc2Sdecision(pc=c(0.10, 0.50), qc=c(log(1), log(0.50)), lower.tail=FALSE, link="log")
...
outcomes <- data.frame(y2=c(0:n_pbo), suc=design_suc(y2=0:n_pbo), fut=design_fut(y2=0:n_pbo), max=n_trt)

...
// this fix is needed for Stan <= 2.19 to avoid warnings under clang
#if STAN_MATH_MAJOR <= 2 & STAN_MATH_MINOR <= 19
...
inline bool is_lower_triangular(
  ...
  // causes clang to complain with
  // warning: 'ptr_fun<double, double>' is deprecated 

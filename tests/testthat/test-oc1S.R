...
test_that("Classical NI design critical value", expect_true( abs(oc1S(prior, 155, decA)() - c1) < eps))
...
test_that("Binary crticial value, lower.tail=TRUE", test_critical_discrete(design_binary, dec1, posterior_binary))
test_that("Binary crticial value, lower.tail=FALSE", test_critical_discrete(design_binaryB, dec1b, posterior_binary))
...
dec_count  <- oc1Sdecision(1-alpha, 1, lower.tail=TRUE)
dec_countB <- oc1Sdecision(1-alpha, 1, lower.tail=FALSE)
...
test_that("Poisson critical value, lower.tail=TRUE", test_critical_discrete(design_poisson, dec_count, posterior_poisson))
test_that("Poisson critical value, lower.tail=FALSE", test_critical_discrete(design_poissonB, dec_countB, posterior_poisson))

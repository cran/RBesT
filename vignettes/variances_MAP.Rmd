...
polygamma function of order 1 (first derivative of the $\log$ of the
$\Gamma$ function).
...
normal endpoint. This approximations becomes more accurate, the larger
the degrees of freedom are. The section at the bottom of this vignette
discusses this approximation accuracy and concludes that independent
of the true $\sigma$ value for 10 observations the approxmation is
useful and a very good one for more than 20 observations.
...
$$ y|\alpha,\beta \sim \Gamma(y|\alpha,\beta) $$
$$ p(z) = p(y) \, y = p(\exp(z)) \, \exp(z) $$
$$ z|\alpha,\beta \sim \log\Gamma(z|\alpha,\beta)$$
$$\Leftrightarrow z|\alpha,\beta \sim \Gamma(\exp(z)|\alpha,\beta) \, \exp(z) $$

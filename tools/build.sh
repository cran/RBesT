...
## compile RBesT dll
"${R_HOME}/bin/R" --vanilla --slave -e 'library(pkgbuild); pkgbuild::compile_dll()'

## create internal data-sets
"${R_HOME}/bin/R" --vanilla --slave --file=tools/make-ds.R

## create documentation Rd files
"${R_HOME}/bin/R" --vanilla --slave -e 'library(devtools); devtools::load_all(); devtools::document()'
